...
#DOCUMENTAÇÃO DO BUG DO CHATTERBOT
...
# CRIAÇÃO DO CHATBOT E TREINAMENTO
chatbot = ChatBot("Seja Bem Vindo", tagger_language = ENGSM)
conversa = [
    "Olá",
    "Olá {{ hospede }}, seja bem vindo ao nosso espaço! Em que posso ajudá-lo?",
    "Eu quero saber do endereço onde vou me hospedar",
    "Rua Paula Gomes 53, Curitiba-PR",
    "Como eu entro no predio ou estabelecimento ou lugar?",
    "Para o endereço citado acima, digite no teclado eletronico 5656# e empurre a porta",
    "Obrigado!",
    "Que bom que conseguiu, precisando retorne, abraço!",
    "Bom dia",
    "Olá {{ hospede }}, seja bem vindo ao nosso espaço! Em que posso ajudá-lo?",
    "Eu quero saber do endereço onde vou me hospedar",
    "Rua Paula Gomes 53, Curitiba-PR",
    ...
    "Que bom que conseguiu, precisando retorne, abraço!",
    "Boa noite!",
    "Nosso horário de atendimento é entre 8:00 às 20:00 todos os dias, tenha uma boa noite!"
]
trainer = ListTrainer(chatbot)
trainer.train(conversa)


# Rota para a página com o formulário e exibição das mensagens
@app.route('/sejaatendido', methods=['GET', 'POST'])
def seja_atendido():
    mensagens = []
    ...
    if request.method == 'POST':
        ...
        mensagens.append((mensagem, str(resposta)))
        return render_template('sejaatendido.html', mensagens=mensagens)
    else:
        # Recupera as mensagens anteriores do histórico
        if 'mensagens' in session:
